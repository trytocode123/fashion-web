                    ...
                    {[img1, img2, img3, img4].map((img, index) => (
                        <SwiperSlide key={index}>
                            <div className="relative w-full h-full overflow-hidden">
                                <img
                                    className="w-full h-full transition-transform duration-[2000ms] hover:scale-110"
                                    src={img}
                                    alt={`Banner ${index + 1}`}
                                />
                                <div
            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-10 lg:px-20 py-12">
                ...
                <div className="mb-16">
                    <div className="flex flex-col mb-8">
                        <span
                            className="text-indigo-600 font-black text-xs uppercase tracking-widest mb-2">Discovery</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <div
                                className="absolute right-0 top-0 bottom-0 w-1/2 bg-indigo-100/50 -skew-x-12 translate-x-10 group-hover:translate-x-0 transition-transform duration-700"></div>
                        </div>
                        ...
                        >
                            ...
                            <div
                                className="absolute right-0 top-0 bottom-0 w-1/2 bg-violet-100/50 -skew-x-12 translate-x-10 group-hover:translate-x-0 transition-transform duration-700"></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-20">
                    <div className="flex justify-between items-end mb-10">
                        <div>
                            <span
                                className="text-zinc-400 font-black text-xs uppercase tracking-widest mb-2 block">Curated</span>
                            <h2 className="text-3xl lg:text-4xl font-black text-zinc-900 tracking-tighter">Featured
                                Products</h2>
                        </div>
                        <button
                    ...
                    {products.length === 0 ? (
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-10 md:gap-x-6 md:gap-y-12">
                            {products.map(product => (
                                ...
                                >
                                    <div
                                        className="relative aspect-[4/5] rounded-[2rem] overflow-hidden bg-zinc-100 mb-6 shadow-sm border border-zinc-100 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-zinc-200 group-hover:-translate-y-2">
                                        <img
                                    ...
                                    <div className="px-2">
                                        <div className="flex justify-between items-start mb-1">
                                            <h3 className="font-black text-zinc-900 text-lg line-clamp-1 flex-grow uppercase tracking-tight"
                                                title={product.name}>
                                                {product.name}
                                            </h3>
                                        </div>
