    ...
    return (
        <div className="min-h-screen bg-zinc-50 pt-[100px] lg:pt-[130px] pb-24 px-4 md:px-10 lg:px-20">
            <div className="max-w-[1400px] mx-auto">
                ...
                {items.length === 0 ? (
                    <div
                        className="bg-white rounded-[2.5rem] shadow-2xl shadow-zinc-100 border border-zinc-100 p-16 text-center animate-scale-in">
                        <div
                        ...
                        <p className="text-zinc-500 font-medium mb-10 max-w-sm mx-auto">Looks like you haven't added
                            anything to your cart yet. Let's find something special for you.</p>
                        <button
                            onClick={() => navigate('/products')}
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                                    ...
                                    >
                                        ...
                                        <div className="flex-grow flex flex-col justify-between w-full">
                                            ...
                                            <div className="flex justify-between items-end mt-6 md:mt-2">
                                                <div
                                                    className="flex items-center bg-zinc-50 rounded-xl p-1 border border-zinc-100">
                                                    <button
                                                    ...
                                                    <span
                                                        className="w-12 text-center font-black text-zinc-900">{item.quantity}</span>
                                                    <button
                                                        disabled={isUpdating}
                                                        onClick={() => handleUpdateQuantity(item.id, item.quantity, 1)}
                                                        className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-white text-zinc-500 hover:text-indigo-600 disabled:opacity-30 transition-all"
                                                ...
                                                <div className="text-right">
                                                    <p className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest mb-1">{item.productPrice.toLocaleString('vi-VN')} ₫
                                                        / item</p>
                        ...
                        <div className="xl:col-span-4 mt-10 xl:mt-0">
                            <div
                                className="bg-zinc-900 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-indigo-100 sticky top-32 overflow-hidden group">
                                <div
                                    className="absolute -top-24 -right-24 w-64 h-64 bg-indigo-600/20 rounded-full blur-[100px] transition-transform duration-[3000ms] group-hover:scale-150"></div>
                                ...
                                <div className="space-y-6 relative z-10">
                                    <div className="flex justify-between items-center text-zinc-400 font-medium">
                                        ...
                                        <span
                                            className="text-white font-black">{totalPrice.toLocaleString('vi-VN')} ₫</span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-end mb-10">
                                        ...
                                        <span
                                            className="text-4xl font-black text-indigo-400">{totalPrice.toLocaleString('vi-VN')} ₫</span>
                                    </div>
                                    ...
                                    <div className="space-y-3 pt-4">
                                        <button
                                            ...
                                            className="w-full bg-white text-zinc-900 py-4 rounded-2xl font-black uppercase tracking-widest text-xs 
                                                     hover:bg-indigo-400 hover:text-white hover:cursor-pointer transition-all duration-300 shadow-xl shadow-black/20 flex items-center justify-center gap-3"
                                        >
                                            Checkout with <img
                                            src="https://vnpay.vn/assets/images/logo-icon/logo-primary.svg"
                                            className="h-5" alt="VNPay"/>
                                        </button>

                                        <div className="relative py-2 text-center">
                                            <span
                                                className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-600">or</span>
                                        </div>

                                        <button
                                            onClick={handlePaypal}
                                            className="w-full bg-[#FFC439] text-indigo-950 py-4 rounded-2xl font-black uppercase tracking-widest text-xs 
                                                     hover:bg-amber-400 hover:text-white hover:cursor-pointer transition-all duration-300 shadow-xl shadow-black/10 flex items-center justify-center gap-3"
                                        >
                                            Checkout with <img
